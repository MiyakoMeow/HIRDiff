...
def parse_args_and_config():
    ...
    # datasets
    parser.add_argument("-dn", "--dataname", type=str, default="WDC", choices=["WDC", "Houston", "Salinas"])
    parser.add_argument("--task", type=str, default="denoise", choices=["denoise", "sr", "inpainting"])
...
if __name__ == "__main__":
    ...
    denoise_model = None
    denoise_optim = None
    denoised_fn = {"denoise_model": denoise_model, "denoise_optim": denoise_optim}
    step = opt["step"]
    dname = opt["dataname"]
